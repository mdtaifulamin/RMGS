...
import { View, Text, TextInput, ScrollView, StyleSheet, Keyboard, Button } from 'react-native';
...
const columnNames = [
   'manpower', 'twoHourOT', 'fourHourOT', 'sixHourOT', 'TNC','remarks'
];

  
  
export default function SpreadsheetForm({defaultValues}) {
  ...
  const [inputData, setInputData] = useState({
    ...
    twoHourOT:defaultValues?defaultValues.twoHourOT.toString():'',
    fourHourOT:defaultValues?defaultValues.fourHourOT.toString():'',
    sixHourOT:defaultValues?defaultValues.sixHourOT.toString():'',
    TNC:defaultValues?defaultValues.TNC.toString():'',
    remarks:defaultValues?defaultValues.remarks.toString():'',
    manpower:defaultValues?defaultValues.manpower.toString():' '
    }||" "
  });
        ...
        <View>
         <View style={styles.row}>
          ...
          <View key={line} style={styles.row}>
            <View key={0} style={styles.inputRow}>
                <TextInput
...
// export default function OverTimeForm({onSubmit,onCancel,onButton, defaultValues,testp}) {
//     const [open, setOpen] = useState(false);
...
//     useEffect(() => {
//     const totalItems = 114; // Total number of items
//     const itemsArray = [];

//     for (let i = 1; i <= totalItems; i++) {
//         itemsArray.push({ label: `${i}`, value: `${i}` });
//     }

//     setlItems(itemsArray);
//     }, []);
...
//     useEffect(() => {
//     const totalItems = 114; // Total number of items
//     const ditemsArray = [{ label: "due", value: "due" }];

//     for (let i = 0; i <= totalItems; i++) {
//         const ordinal = (i > 0) ? (i === 1 ? "st" : (i === 2 ? "nd" : (i === 3 ? "rd" : "th"))) : "";
//         ditemsArray.push({ label: `${i}${ordinal}`, value: `${i}${ordinal}` });
//     }

//     setdItems(ditemsArray);
//     }, []);
...
//                        },              
//         TWO_HOUR_OT:{
//                            value: defaultValues?defaultValues.TWO_HOUR_OT.toString():'',
//                            isValid: true
//                           },
//         manpower:{
...
//                           },
//         2:{
//                            value: defaultValues?defaultValues.2.toString():'',
//                            isValid: true
//                         } ,                 
...
//                                                     TWO_HOUR_OT:       +inputs.TWO_HOUR_OT.value,
...
//                                 const lineNumberIsValid = true;//overTimeData.lineNumber.trim().length > 0;  //!isNaN(overTimeData.lineNumber.trim()) && overTimeData.lineNumber.trim().length > 0;
//                                 const buyerNameIsValid = true;
//                                 const SOIsValid = true;
//                                 const styleNameIsValid = true;
//                                 const dateIsValid = true;
//                                 const itemNameIsValid= true;
//                                 const TWO_HOUR_OTIsvalid = true;
//                                 const 2Isvalid=true;
...
//                                 const remarksIsValid= true;
   
//                                 if ( !lineNumberIsValid || !buyerNameIsValid || !SOIsValid || !styleNameIsValid || !itemNameIsValid|| !dateIsValid || !TWO_HOUR_OTIsvalid ||!manpowerIsvalid ||!2Isvalid || !hourIsvalid || !productionIsvalid ||!withoutsvalid || !dueIsvalid || !rejectionIsvalid||!remarksIsValid){
//                                     setInputs((curInputs)=>{
...
//                                             TWO_HOUR_OT:{ value:curInputs.TWO_HOUR_OT.value, isValid:TWO_HOUR_OTIsvalid},
//                                             manpower:{ value:curInputs.manpower.value, isValid:manpowerIsvalid},
//                                             2:{value:curInputs.2.value, isValid:2Isvalid},
...
//             <Text style={styles.title}>Your line-wise style overTime Data</Text>
...
//                     <Input 
//                         style={styles.rowInput}
//                         invalid={!inputs.TWO_HOUR_OT.isValid}
//                         label='TWO_HOUR_OT:' textInputConfig={{
//                             keyboardType:'phone-pad',
//                             maxLentgh: 10,
//                             onChangeText: inputChangeHandler.bind(this,'TWO_HOUR_OT'),
//                             value: inputs.TWO_HOUR_OT.value,
//                         }} />
//                 </View>
//                 <View style={styles.inputsRow}>
...
//                 <Input 
//                     style={styles.rowInput}
//                     invalid={!inputs.2.isValid}
//                     label={'Target ( 10 hours ):' + inputs.hour.value*(inputs.2.value)/10} textInputConfig={{
//                         keyboardType:'phone-pad',
//                         maxLentgh: 10,
//                         onChangeText: inputChangeHandler.bind(this,'2'),
