        ...
        <View style={styles.buttonRow}>
          <Animated.View style={[styles.buttonContainer, { transform: [{ translateY: buttonTransform }] }]}>
            ...
            <View style={{flexDirection:'row'}}>
              <Entypo name="location" size={24} color="#21B4CB" />
              <MaterialIcons name="qr-code-scanner" size={24} color="#21B4CB" />
            </View>
          ...
          <Animated.View style={[styles.buttonContainer, { transform: [{ translateY: buttonTransform }] }]}>
            ...
            <View style={{flexDirection:'row'}}>
              ...
              <MaterialCommunityIcons name="book-search-outline" size={24} color="#21B4CB" />
            </View>
        ...
        <View style={styles.buttonRow}>
          <Animated.View style={[styles.buttonContainer, { transform: [{ translateY: buttonTransform }] }]}>
            ...
            <View style={{flexDirection:'row'}}>
              ...
              <MaterialCommunityIcons name="book-account-outline" size={24} color="#21B4CB" />
            </View>
