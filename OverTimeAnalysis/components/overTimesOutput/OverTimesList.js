...
// export default function OverTimesList({ overTimes, refreshing, onRefresh, }) {
...
export default function OverTimesList({ overTimes, refreshing, onRefresh,onLongPress}) {
  ...
  const renderOverTimeItem = ({item,index}) => {
...
//   const renderOverTimeItem = (itemData) => {
//     return (
//       <Animated.View style={{ opacity: fadeAnim }}>
//         <OverTimeItem {...itemData.item} />
//       </Animated.View>
//     );
//   };
