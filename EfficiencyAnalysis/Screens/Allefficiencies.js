...
return (
    <>
        ...
        <View style={{flexDirection:'row', backgroundColor:GlobalStyles.colors.backroundColor,paddingVertical:10,marginBottom:1.5}}>
            <View style={{flex:2, zIndex:10000, backgroundColor:GlobalStyles.colors.backroundColor,borderRadius:10,borderWidth:.2,borderRightWidth:.2,marginHorizontal:'1%'}}>
                    <TextInput style={{padding:11,}} value={linevalue}placeholder="Line:" onChangeText={onchangeHandler}/>
            </View>
            <View style={{backgroundColor:GlobalStyles.colors.backroundColor,flex:4,borderRadius:10,borderWidth:.2,maxHeight:'100%'}}>
            ...
            <View style={{flex:3,justifyContent:'center',backgroundColor:GlobalStyles.colors.backroundColor,paddingHorizontal:5}}>
